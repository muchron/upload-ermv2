            ...
            <div id="upload-image" style="visibility: hidden">
                ...
                <form action="upload" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <input type="hidden" id="usermane" name="username" value="admin">
                    </div>
                    <div class="mb-3">
                        <input class="form-control" type="file" id="file" name="file" multiple onchange="previewImage(this)" style="display: none">
                    </div>
                    <div class="d-grid gap-2">
                        <label type="button" class="btn btn-success" width="100%" for="file">Tambah</label>
                        <button type="button" class="btn btn-primary btn-sm" id="submit" onclick="simpan()">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
